...
#define LOG_WARN(ctx, fmt, ...) DISCOVERY_LOG(ctx, DISCOVERY_LOG_LEVEL_WARN, fmt, __VA_ARGS__)
#define LOG_ERROR(ctx, fmt, ...) DISCOVERY_LOG(ctx, DISCOVERY_LOG_LEVEL_ERROR, fmt, __VA_ARGS__)
#define LOG_CRITICAL(ctx, fmt, ...) DISCOVERY_LOG(ctx, DISCOVERY_LOG_LEVEL_CRITICAL, fmt, __VA_ARGS__)
